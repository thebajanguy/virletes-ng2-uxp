...
//identity/account/auth  // identity/account/susi
  appSettings: {
    ...
    siteUrl: 'http://localhost:4900/', // The redirect URI of the application, this should be same as the value in the application registration portal.Defaults to window.location.href.
  ...
  aadB2C: {
    ...
    redirectPath: 'identity/account/auth',
    loginRedirectPath: 'userworkspace/account',
  },
  msalConfig: {
    auth: {
  ...
  protectedResources: {
    ...
    graphMe: {
      ...
      //scopes: ['https://sportstechb2bc.onmicrosoft.com/66a0b2f1-72c8-4f7f-aa5c-216e64ae7206/User.ReadWrite.All', 'https://VirLetesb2c.onmicrosoft.com/66a0b2f1-72c8-4f7f-aa5c-216e64ae7206/User.Read.All', 'https://VirLetesb2c.onmicrosoft.com/66a0b2f1-72c8-4f7f-aa5c-216e64ae7206/User.Read' ],  //User.ReadWrite.All&response_type=code  .default
    },
    graphContacts: {
