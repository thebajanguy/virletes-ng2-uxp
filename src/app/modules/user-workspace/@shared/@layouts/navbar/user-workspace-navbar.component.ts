import { Component, OnInit, ElementRef, Injector, Inject } from '@angular/core';
import { ROUTES } from '../sidebar/user-workspace-sidebar.component';
...
@Component({
  selector: "app-user-workspace-navbar-cmp",
  templateUrl: "./user-workspace-navbar.component.html",
  styleUrls: ["./user-workspace-navbar.component.scss"]
})
export class UserWorkspaceNavbarComponent extends BaseSusiComponent implements OnInit {
  ...
  constructor(
    public override location: Location,  private element: ElementRef,
